...
// {
//     [SerializeField]
//     private bool useArtNetwithREC = false;
//     // [SerializeField] private DMXChannel artNetChannels = null;
//     // todo: リストで動く軽量なDMXチャンネルを持ったクラスを作る
//     // [SerializeField] 
//     // private DMXChannelList dmxChannelList = null;
//     [SerializeField] private NewDmxChannelList dmxChannelList = null;
...
//         // }
//         // if (dmxChannelList == null)
//         // {
//         //     dmxChannelList = GameObject.Find("LightConsole").GetComponent<DMXChannelList>();
//         // }
...
//                 if (_Panpart != null)
//                 {
//                     _p = dmxChannelList.DMXChannel[_panChannel - 1] / 255f;
//                 }
//                 // _p = dmxChannelList[_panChannel] / 255f;
//                 if (_Tiltpart != null)
//                 {
//                     _t = dmxChannelList.DMXChannel[_tiltChannel - 1] / 255f;
//                 }
//                 // _t = dmxChannelList[_tiltChannel] / 255f;
//                 _r = dmxChannelList.DMXChannel[_redChannel - 1] / 255f;
//                 _g = dmxChannelList.DMXChannel[_greenChannel - 1] / 255f;
//                 _b = dmxChannelList.DMXChannel[_blueChannel - 1] / 255f;
//                 _w = dmxChannelList.DMXChannel[_whiteChannel - 1] / 255f;
//                 _i = dmxChannelList.DMXChannel[_intensityChannel - 1] / 255f;
//             }
//         }
//         // if(_Panpart != null)
//         // {
